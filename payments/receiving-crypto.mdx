...
- **Solana address** — a separate Solana wallet address for clients paying on the Solana network.
  You can view your wallet addresses from your profile. The payment pages shown to your clients automatically display the correct address for the chain they select. **Solana address** — a separate Solana wallet address for clients paying on the Solana network.
