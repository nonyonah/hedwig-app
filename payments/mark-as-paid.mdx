...
description: "Capture payment method and reference when an invoice or payment link settles outside Hedwig — bank transfer, cash, Stripe, Paystack — so revenue tracking stays accurate."
icon: "check"
---
