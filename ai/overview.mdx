...
<Steps>
  <Step title="Open the Creation Box">
    On the web dashboard, find the floating icon that has the Hedwig logo in the bottom right of the screen.
  </Step>
...
- **Web dashboard:** open the assistant panel from the floating icon
