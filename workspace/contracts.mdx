...
<Note>
Contracts use AI to generate the document text. The AI uses the actual date of creation, your real name and email, and the client details you provide — it does not insert placeholder text like "[Date]" or "[Address]".
</Note>
