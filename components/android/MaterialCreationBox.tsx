                        ...
                        <View style={[styles.actionsRow, { borderTopColor: themeColors.border }]}>
                            ...
                            <TouchableOpacity
                                style={[
                                    styles.actionPill,
                                    {
                                        borderColor: effectivePriority
                                            ? PRIORITY_COLORS[effectivePriority]
                                            : themeColors.border,
                                        backgroundColor: effectivePriority
                                            ? PRIORITY_COLORS[effectivePriority] + '20'
                                            : 'transparent',
                                    },
                                ]}
                                onPress={onPriorityTap}
                                android_ripple={{
                                    color: effectivePriority
                                        ? PRIORITY_COLORS[effectivePriority]
                                        : themeColors.border,
                                    borderless: false,
                                }}
                            ...
                            {(detectedIntent === 'contract' || detectedIntent === 'unknown') && (
                                <TouchableOpacity
                                    style={[styles.actionPill, { borderColor: themeColors.border }]}
                            ...
                            {/* More Pill */}
                            <TouchableOpacity
                                style={[styles.iconOnlyPill, { borderColor: themeColors.border }]}
                                android_ripple={{ color: themeColors.border, borderless: true }}
                            >
