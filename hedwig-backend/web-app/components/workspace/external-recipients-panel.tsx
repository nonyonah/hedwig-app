...
export function ExternalRecipientsPanel({ workspaceId, accessToken }: { workspaceId: string; accessToken: string | null }) {
 ...
 <div>
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Wallet address (Base network)</span>
 <input
 type="text"
 placeholder="0x..."
 value={walletAddress}
 ...
 <div>
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Notes (optional)</span>
 <input
 type="text"
