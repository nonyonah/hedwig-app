    ...
    <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4">
     {step === 'review' && (
      <>
       ...
       <div className="flex gap-3">
        ...
        <Button variant="default" onClick={handleSend} disabled={!ready} className="flex flex-1 items-center justify-center gap-2">
     ...
     {step === 'done' && (
      <div className="flex flex-col items-center gap-5 py-12 text-center">
       ...
       <Button variant="default" onClick={onClose} className="w-full">Done</Button>
      </div>
     )}
