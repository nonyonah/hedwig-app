...
function AddFundsButton() {
 ...
 <p className="text-[11px] font-semibold text-[var(--color-text-muted)]">Bank</p>
 ...
 <div>
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Payment network</span>
 ...
 <p className="text-[11px] font-medium text-[var(--color-text-muted)]">Total going out</p>
 ...
 {schedFreq === 'monthly' && (
 <div>
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Day of month</span>
