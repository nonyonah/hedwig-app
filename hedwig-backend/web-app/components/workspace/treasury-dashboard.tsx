    ...
    <div>
      ...
      <div className="mb-4 grid grid-cols-4 gap-px overflow-hidden rounded-2xl bg-[var(--color-border)] ring-1 ring-[var(--color-border)]">
        <div className="bg-[var(--color-surface)] px-4 py-3.5">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-muted)]">Total balance</p>
        ...
        <div className="bg-[var(--color-surface)] px-4 py-3.5">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-muted)]">Collected (30d)</p>
          <p className="mt-1.5 text-[20px] font-bold leading-none tracking-[-0.03em] text-[var(--color-foreground)]">
        ...
        <div className="bg-[var(--color-surface)] px-4 py-3.5">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-muted)]">Pending</p>
          <p className="mt-1.5 text-[20px] font-bold leading-none tracking-[-0.03em] text-[var(--color-foreground)]">
        ...
        <div className="bg-[var(--color-surface)] px-4 py-3.5">
          <p className="text-[10px] font-semibold uppercase tracking-widest text-[var(--color-text-muted)]">Settled (30d)</p>
          <p className="mt-1.5 text-[20px] font-bold leading-none tracking-[-0.03em] text-[var(--color-foreground)]">
