        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--color-text-placeholder)]">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl bg-[var(--color-background)] p-4">
            ...
            <label className="mt-4 block">
              <span className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.12em] text-[var(--color-text-placeholder)]">
                Detected value
              </span>
              <input
                value={editedValue}
