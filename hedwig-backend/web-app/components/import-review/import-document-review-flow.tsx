...
function ResultBucket({
 ...
 <p className="text-[12px] font-semibold text-[var(--color-text-placeholder)]">{title}</p>
 {items.length ? (
...
export function ImportDocumentReviewFlow({
 ...
 <div>
 <p className="text-[11px] font-semibold text-[var(--color-text-placeholder)]">Import review</p>
