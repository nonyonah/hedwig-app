          ...
          <div className="flex items-center justify-between border-b border-[var(--color-border)] px-6 py-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--color-accent-soft)]">
                <FileText className="h-4 w-4 text-[var(--color-text-tertiary)]" weight="bold" />
              </div>
              <div>
                <p className="text-[15px] font-semibold text-[var(--color-foreground)]">New invoice</p>
                <p className="text-[11px] text-[var(--color-text-muted)]">Bill a client for work or services</p>
              </div>
            </div>
            <button
              type="button"
            ...
            <div className="space-y-4 px-6 py-5">
              ...
              <div>
                <label className="mb-1.5 block text-[12px] font-semibold text-[var(--color-text-secondary)]">
                  Amount (USD) <span className="text-[var(--color-text-tertiary)]">*</span>
                </label>
              ...
              {/* Client name */}
              <div>
                <label className="mb-1.5 block text-[12px] font-semibold text-[var(--color-text-secondary)]">Client name</label>
                <input
                  type="text"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-full border border-[var(--color-border-input)] px-4 py-2.5 text-[13px] text-[var(--color-foreground)] outline-none transition focus:border-[var(--color-accent)] focus:ring-2 focus:ring-[var(--color-accent)]/30"
                />
                <p className="mt-1 text-[11px] text-[var(--color-text-muted)]">Invoice will be emailed to this address when provided.</p>
              </div>
            </div>
