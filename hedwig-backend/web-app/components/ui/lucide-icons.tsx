...
export const Terminal = makeIcon('TerminalIcon', 'CommandLineIcon', 'ConsoleIcon');
export const ThumbsUp = makeIcon('Like01Icon', 'ThumbsUpIcon');
export const ThumbsDown = makeIcon('DislikeIcon', 'ThumbsDownIcon');
