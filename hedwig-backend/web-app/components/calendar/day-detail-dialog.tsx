...
export function DayDetailDialog({
 ...
 {isReminder && (
 <div>
 <dt className="text-[11px] font-semibold text-[var(--color-text-muted)]">Category</dt>
 <dd className="mt-0.5 text-[13px] font-medium text-[var(--color-foreground)]">{item.subtitle}</dd>
 </div>
 )}
 <div>
 <dt className="text-[11px] font-semibold text-[var(--color-text-muted)]">Date</dt>
 ...
 {!isReminder && (
 <div>
 <dt className="text-[11px] font-semibold text-[var(--color-text-muted)]">Status</dt>
