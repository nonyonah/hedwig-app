...
export function OfframpModal({ open, onClose, source, workspaceId, returnAddress, maxAmount, chainBalances, accessToken, solanaAddress }: OfframpModalProps) {
 ...
 <div>
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Amount (USDC)</span>
 <input
 type="text"
 inputMode="decimal"
 placeholder="0.00"
 ...
 <div>
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Memo (optional)</span>
 <input
 type="text"
