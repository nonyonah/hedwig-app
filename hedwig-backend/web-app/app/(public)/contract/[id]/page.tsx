...
export default async function PublicContractPage({
 ...
 <p className="text-[11px] font-semibold text-[var(--color-text-muted)]">Contract</p>
 ...
 <p className="text-[10px] font-semibold text-[var(--color-text-muted)]">Freelancer</p>
 </div>
 ...
 <div className="flex items-center gap-1.5 mb-1">
 <User className="h-3 w-3 text-[var(--color-text-muted)]" weight="bold" />
 <p className="text-[10px] font-semibold text-[var(--color-text-muted)]">Client</p>
 </div>
 ...
 <p className="text-[10px] font-semibold text-[var(--color-text-muted)]">Created</p>
 </div>
