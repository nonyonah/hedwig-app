...
export default async function PublicInvoicePage({
 ...
 <p className="text-[11px] font-semibold text-[var(--color-text-muted)]">Invoice</p>
 {isRecurring && (
 ...
 <div className="flex items-center gap-1.5 mb-1">
 <User className="h-3 w-3 text-[var(--color-text-muted)]" weight="bold" />
 <p className="text-[10px] font-semibold text-[var(--color-text-muted)]">To</p>
 </div>
 ...
 <p className="text-[10px] font-semibold text-[var(--color-text-muted)]">Due</p>
 </div>
 ...
 <span className="text-[11px] font-semibold text-[var(--color-text-muted)]">Description</span>
 <span className="text-center text-[11px] font-semibold text-[var(--color-text-muted)]">Qty</span>
 ...
 <p className="mb-2 text-[10px] font-semibold text-[var(--color-text-muted)]">Notes</p>
