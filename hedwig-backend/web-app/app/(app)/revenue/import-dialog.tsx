...
export function ImportDialog({ open, onClose, onImported, accessToken }: ImportDialogProps) {
 ...
 <th className="px-2 py-2 text-[10px] font-semibold text-[var(--color-text-muted)]">Date</th>
 <th className="px-2 py-2 text-[10px] font-semibold text-[var(--color-text-muted)]">Description</th>
 <th className="px-2 py-2 text-[10px] font-semibold text-[var(--color-text-muted)]">Amount</th>
 <th className="w-32 px-2 py-2 text-[10px] font-semibold text-[var(--color-text-muted)]">Category</th>
 </tr>
 </thead>
