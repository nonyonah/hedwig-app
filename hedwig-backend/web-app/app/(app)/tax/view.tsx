...
export function TaxWorkspaceClient({
 ...
 <p className="text-[12px] font-semibold text-[var(--color-text-muted)]">Income by client</p>
 ...
 <div>
 <div className="mb-3 flex items-center justify-between">
 <p className="text-[12px] font-semibold text-[var(--color-text-muted)]">Income by project</p>
