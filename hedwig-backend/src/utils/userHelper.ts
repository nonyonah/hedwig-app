...
export async function getOrCreateUser(privyId: string) {
    try {
        ...
        if (user && !error) {
            ...
            // Stellar wallet lazy-migration was here but is disabled until Stellar is re-enabled.
        ...
        if (existingUser && !emailError) {
            ...
            // Stellar keypair creation was here but is disabled until Stellar is re-enabled.
